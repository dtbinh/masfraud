 ...
 *
 */
public class SpecialistRedemptionAgent extends BaseAgent{
	...
	public String getRoleName() {
		return RoleNameConstants.SPECIALIST_REDEMPTION.getValue();
	}


	@Override
	public BaseMessageRouter getMessageRouter() {
		return new SpecialistRedemptionMessageRouter();
	}
